...
public class LordsDebate implements Comparable<LordsDebate> {
	...
	public void setChamber(String chamber) {
		...
		} else if(chamber.equals("Grand Committee")) {
			this.chamber = Chamber.GRAND;
		} else {
			this.chamber = Chamber.OTHER;
		}
	}
	...
	public LordsDebate copy() {
		return new LordsDebate(chamber,
				     title,
				     committee,
				     subject,
				     guid,
	...
	public boolean equals(Object obj) {
		...
		if(getClass() != obj.getClass())
			return false;
		LordsDebate other = (LordsDebate) obj;
		if(date == null) {
			if(other.date != null)
				return false;
	...
	public int compareTo(LordsDebate another) {
