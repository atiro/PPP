...
public class ReaderNewFragment extends SherlockListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		//Log.v("PPP", "creating ReaderNewFragment");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		Log.v("PPP", "Creating ReaderNewFragment view");
	...
	public void onDestroy() {
		super.onDestroy();
		Log.v("PPP", "ReaderNewFragment - onDestroy");
	...
	public void onPause() {
		...
		Log.v("PPP", "ReaderNewFragment - onPause");
	...
	public void onResume() {
		super.onResume();
		Log.v("PPP", "ReaderNewFragment - onResume");
